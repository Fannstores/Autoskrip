...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[92;1m              𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 SCRIPT FANTUNELL              \033[0m"
echo -e "${aqua}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "${EROR} Your Architecture Is Not Supported ( ${aqua}$( uname -m )${NC} )"
exit 1
fi
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Cloder07/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Cloder07/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Cloder07/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Fannstores/Fanstores/main/"
start=$(date +%s)
secs_to_human() {
...
echo -e " Your OS Is Not Supported ( ${aqua}$(cat /etc/os-release | grep -w PRETTY_NAME | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/PRETTY_NAME//g')${FONT} )"
fi
}
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Fannstores/Fanstores/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Fannstores/Fanstores/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/SkayzuII"},{"text":"WA","url":"https://wa.me/6282129531441"}]]}'
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/Fannstores/Fanstores/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/Cloder07/script-new/main/Cfg/m-noobz 
